...
if (loginEmail && loginPassword && loginButton) {
  ...
  function attemptLogin() {
    ...
    try {
      console.log("[Login] OK:", normalizeEmail(loginEmail.value));
    } catch (e) {}
...
if (
  ...
  function attemptRegister() {
    ...
    var okPass2 =
      !isEmpty(regPassword2.value) && regPassword2.value === regPassword.value;
    ...
    try {
      console.log("[Registro] Nuevo usuario:", newUser);
      console.log("[Registro] Usuarios guardados (JSON):", users);
    } catch (e) {}

    try {
      localStorage.setItem("clase01_last_email", newUser.email);
    } catch (e) {}

    try {
      window.alert("Cuenta creada. Ahora inicia sesión.");
    } catch (e) {}
  ...
  regPassword2.addEventListener("keydown", function (e) {
